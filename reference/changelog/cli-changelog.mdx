...
- **Sentry error reports now include user context** — When an authenticated user triggers an error, their user ID and email are now attached to the Sentry report, making it faster to diagnose and reproduce user-specific issues.
