...
- **Sentry distributed tracing for all commands** — All CLI commands are now instrumented with Sentry spans (child spans for key operations) and custom counter/distribution metrics. This internal observability work enables detailed performance profiling and faster diagnosis of production issues, with no user-visible changes.
