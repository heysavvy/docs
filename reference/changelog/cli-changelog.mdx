...
<Update label="v0.9.2 — 24 February 2026">

### Chores

- **Sentry release naming updated** — The Sentry release identifier format has changed from `@embeddables/cli@<version>` to `embeddables-cli@<version>`, aligning with standard Sentry release naming conventions. This affects internal error tracking only and has no impact on CLI behaviour.
