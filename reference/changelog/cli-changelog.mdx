...
<Update label="v0.9.4 — 24 February 2026">

### Chores

- **npm package README links updated** — The "Getting Started" link in the npm package README has been replaced with direct links to [Building with AI](https://docs.embeddables.com/cli/ai) and [Troubleshooting](https://docs.embeddables.com/cli/troubleshooting) for better navigation. The beta notice was also tightened to emphasise checking the diff before saving.
