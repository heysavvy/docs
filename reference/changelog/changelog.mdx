...
- 👥 Persona Preview Dropdown – Added a "Personas" dropdown next to the "Feedback" button in Preview mode. Switch between personas directly in Preview mode, plus edit existing ones or create new ones on the spot!
...
- 🔒 Webhook Management Restrictions – HIPAA-regulated companies now have webhook management disabled for non-Data Privacy Officers, enhancing security compliance.
...
- 📊 Experiment View Percentage Fix – Fixed incorrect display of absolute values with % symbols when toggling to percentage view.
...
- 📏 Breadcrumb Text Wrapping – Long names no longer cause awkward wrapping in breadcrumb navigation.
