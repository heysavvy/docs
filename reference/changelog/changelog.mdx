...
- 🌐 **New Generation Embeddables** – Goals, Tasks, QA, Inbox, and the full sidebar navigation (including "Improve" and "Content" section headings) are now available to all customers. The "+" Create dropdown also now includes New Task, New Goal, and New QA Test for everyone — no special access required.
