...
- 🚫 **is_exit_page property** - Prevent users from progressing past specific pages in your flow
- 📐 **Collapsible left sidebar** - More room to build!
- 🔄 **Additional page transition options** - Smooth and customized flow transitions for better UX (no builder UI yet coming soon!)
- 🎯 **Custom selector management** - Define and apply custom selectors directly inside your components
...
- Streamlined Stripe Component Edit History - Edit history is now more readable
