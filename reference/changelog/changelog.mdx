...
- 📊 **Rename & Duplicate Saved Views from Analytics Home** – Saved analytics views can now be renamed and duplicated directly from the Analytics Hub home, without opening the view first. Double-click a view's title (or use the new row **⋯** menu → **Rename**) to edit its name inline — press **Enter** to save or **Escape** to cancel. Choose **Duplicate** to create a full copy of the view (titled `… (copy)`) placed directly beneath the original and ready to rename straight away.

### ⚡️ Improvements

- **Saved View Row Overflow Menu** – Each saved view row now has a single **⋯** overflow menu that gathers **Rename**, **Duplicate**, and **Delete**, replacing the standalone delete icon. A plain click on a view's title still opens it, while modifier- and middle-clicks continue to open it in a new tab.
</Update>
