...
- 🔕 **QA Test Notifications Removed** – The QA worker no longer sends completion, failure, or error notifications for QA runs. This is part of decommissioning the Knock-powered Inbox. QA runs are unaffected otherwise — they continue to capture screenshots at each step, persist results to your project, and run on their existing schedules.
</Update>
