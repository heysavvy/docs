...
- 💳 **Stripe Checkout v2 Component Options** - More flexibility for everyone with enhanced payment customization.
- 🏷️ **Conditional Tags** are now officially live—tag smarter, not harder.
- 📄 **Brand New Pages Grid** - Better layout, better vibes for managing your pages.

### ⚡️ Improvements

- Added support for `payment_intent_data.capture_method` in Stripe payments for more control over payment processing.
