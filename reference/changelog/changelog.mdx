...
- 🎛️ **Advanced component options & ChatMessages deprecation** - Added advanced configuration support for components like Calendly, HubSpot, Lottie, MediaEmbed, File Upload, Rive, PayPal, and Progress Bar.
- 💳 **Stripe Event Trigger Options** - Added support for triggering workflows based on specific Stripe events: payment attempt, failure, or completion.
