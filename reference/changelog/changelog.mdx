...
- 🧠 **Real-time Schema Enforcemen** – The Builder now displays warnings, hints and automatic fixes in places like the Layers sidebar, whenever there are issues with the schema the need to be fixed.
