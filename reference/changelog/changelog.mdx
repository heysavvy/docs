...
- 🤝 **External edits & version status listeners** - Better sync for collaborative workflows!
- 🎛️ **Advanced component options & ChatMessages deprecation** - More control over more advanced components!
- 💳 **Stripe Event Trigger Options** - Flexibility for payment-triggered workflows
