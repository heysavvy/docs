...
- 🛡️ **Builder Safe Mode** – Launch the builder in safe mode using `?embeddables_safe_mode=true` to prevent actions and computed fields from running. Great for troubleshooting!
...
- Experiment Variant Preview Links – You can now preview experiment variants in drafts with a dedicated link.
- Show All CMS Records – The CMS Controller Type now includes an option to "show all records" for easier data management.
</Update>
