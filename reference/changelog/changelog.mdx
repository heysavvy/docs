...
- **Session Replay console errors suppressed** – A broken Clickhouse proxy call in the session replay pipeline was producing spurious `console.error` messages in customer sites. The call has been disabled until the endpoint is fixed or removed, eliminating the noise without affecting any session replay functionality.
</Update>
