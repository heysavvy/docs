...
<Info>
  **Current version: 0.14.4** — See the [CLI Changelog](/reference/changelog/cli-changelog) for what's new.
</Info>
...
The CLI is built for **AI-assisted editing**. Running `embeddables init` injects context files for **Cursor**, **Claude**, **Codex**, and **Antigravity** so AI assistants understand Embeddable components, keys, and conventions out of the box.
