...
This documentation includes both **InputBox-specific settings** (unique to Input Box components) and **general settings** (shared across multiple component types but also available for Input Box).
...
<AccordionGroup>
  <Accordion title="User Input">
    ...
    **Options**:
    ...
    <Info>
    This is a general setting that applies to InputBox, OptionSelector, CustomButton, Calendly, Hubspot, FileUpload (with uploadFile), and PaypalCheckout components.
    </Info>
...
<AccordionGroup>
  ...
  <Accordion title="Ignore in QA tests">
    ...
    **Options**:
    ...
    <Info>
    This is a general setting that applies to CustomButton and InputBox components.
    </Info>
