...
<AccordionGroup>
  ...
  <Accordion title="Formula">
    ...
    Custom validation functions receive the input value as the first argument and optionally the full current User Data as the second argument:
    ...
    // value + userData (access other fields in the flow)
