...
This is expected behaviour, but in some situations can confuse users who were actually
...
The solution to this is our **Sync Pages With The URL** feature, which you can find in
the Embeddable-Wide Settings.
