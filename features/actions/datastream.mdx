...
Sometimes you will want to send [User Data](#user-data) to an external service like Airtable, and then keep sending the updated User Data as the user fills out more information.
...
Right now, only the [Airtable](/features/actions/airtable) integration supports DataStream.
...
<Steps>
  <Step title="Start with an Action + Trigger">
