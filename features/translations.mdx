...
- If you **leave the field without making any change**, the translation stays empty and the default language continues to be shown.
- If you **make any edit**—even adding or removing a single space—the translation is saved and the translated value is shown for that language.
