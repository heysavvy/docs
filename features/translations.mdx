...
This applies to components that expose translatable fields in the Content section: **Plain Text**, **Rich Text**, **Rich Text Markdown**, **Custom HTML**, **Input Box**, **Option Selector**, **Custom Button**, **File Upload**, **Media Image**, and **Stripe Checkout** (Pay button text and Success message).
