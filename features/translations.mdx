...
**Stripe Checkout 2** also supports translations for its **pay button text** and **success message** fields. When translation variants are configured for these fields, they update correctly when the active language changes.
