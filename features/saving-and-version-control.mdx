...
Whenever you make any edit in the Builder (adding a page, changing text, setting up a [Split Test](/features/split-testing), updating logic, etc), that edit becomes part of your unsaved edits.
...
<Tip>
  ...
  Embeddables](/features/url-params).
</Tip>
