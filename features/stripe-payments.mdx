...
<AccordionGroup>
  ...
  <Accordion title="Automatically set default payment methods in Stripe">
    You can automatically set the first payment method added to a customer as their default in Stripe by setting up a webhook from Stripe to Embeddables.
    
    See the [How To: Automatically set default payment methods in Stripe](/how-to/assign-default-payment-methods) guide for step-by-step instructions.
  </Accordion>
