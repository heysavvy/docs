...
- Page View
  - Properties: `page_key` — you can select **one or more** page keys; the conversion fires when the user views any of the selected pages.
- Button Click
  - Properties: `button_key` — you can select **one or more** button keys; the conversion fires when the user clicks any of the selected buttons.
- Custom Event
