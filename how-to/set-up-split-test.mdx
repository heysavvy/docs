---
title: "How To: Set up a Split Test in Embeddables"
sidebarTitle: "How To: Set up a Split Test"
description: "Creating an experiment, setting variants and modifying content"
---

Experiments are deeply intergated into the Embeddables platform. They make use of two of the core features of Embeddables: [Conditions](/how-to/use-conditions) and User Data.
