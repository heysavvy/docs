...
<Tabs>
  ...
  #### Adding the webhook to Stripe with Workbench enabled
    ...
    <Steps>
      ...
      <Step title="Add your endpoint and create the webhook">
        ...
        ```
        https://webhooks.embeddables.com/webhooks/stripe/payment_method.attached?project_id=<YOUR_PROJECT_ID>&test=true
        ```
  ...
  #### Adding the webhook to Stripe with Workbench disabled
