---
title: "Control Stripe Prices from the Embeddables CMS"
sidebarTitle: "Control Stripe Prices from the Embeddables CMS"
...
<Steps>
  ...
  <Step title="Finally, update the Stripe Checkout to use the output of the Computed Field">
    - Go to your checkout page and select your Stripe Checkout component (if you haven't already set this up, you can read how to do that [here](/features/payments/stripe/overview)).
