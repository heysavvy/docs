...
<AccordionGroup>
  ...
  <Accordion title="Where can I see the history of versions deployed to production?">
    To view the history of versions that have been pushed to production:

    1. **Click on Version Control** in the top bar of the Builder.
    2. **Go to the Logs tab**.
    3. This shows a history of when versions were pushed to production.
