...
<AccordionGroup>
  ...
  <Accordion title="Why can't I see user details or search by email address?">
    If you cannot see user details or search for users by email address, this is due to your data access permissions. This restriction is in place to maintain HIPAA compliance and protect sensitive user information.
